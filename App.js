...
import { ListaServicos } from './views/Servico/ListaServico';
    ...
    <div>
     <Router>
       ...
       <Switch>
         ...
         <Route  path ="/Visualizar-pedidos" component={ListarPedido}/>
         <Route path ="/lista-servicos" component={ListaServicos}/>
